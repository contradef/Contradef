...
3. Clique em **Mais Informações** na tela do Microsoft defender SmartScreen.  
   <p align="center"><img src="12_1.png" alt="Microsoft defender SmartScreen" width="55%"></p>

4. Clique em **Executar assim mesmo**.  
   <p align="center"><img src="12_2.png" alt="Confirmar Microsoft defender SmartScreen" width="55%"></p>

5. Confirme o UAC clicando em **Sim**.  
   <p align="center"><img src="13.png" alt="Confirmar UAC" width="55%"></p>

6. O script exibirá mensagens indicando:  
   * Desativação do UAC.  
   * Desativação do Windows Defender.  
   * Desativação da proteção em tempo real.  
   * Habilitando a execução de scripts ps1.  
   <p align="center"><img src="14.png" alt="Saída do script" width="75%"></p>

7. Pressione qualquer tecla quando solicitado e **reinicie a VM** para aplicar as alterações.
