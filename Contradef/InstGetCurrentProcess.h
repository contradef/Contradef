#pragma once
#ifndef INST_GET_CURRENT_PROCESS_H
#define INST_GET_CURRENT_PROCESS_H
...
class InstGetCurrentProcess : public InstrumentationStrategy {
public:
...
private:
    ...
    static VOID CallbackAfter(THREADID tid, UINT32 callId, ADDRINT instAddress, ADDRINT rtn, CONTEXT* ctx, ADDRINT retVal, ADDRINT returnAddress);
};

#endif // INST_GET_CURRENT_PROCESS_H
