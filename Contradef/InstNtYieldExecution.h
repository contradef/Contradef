#pragma once
#ifndef INST_NT_YIELD_EXECUTION_H
#define INST_NT_YIELD_EXECUTION_H
...
class InstNtYieldExecution : public InstrumentationStrategy {
public:
...
#endif // INST_NT_YIELD_EXECUTION_H
