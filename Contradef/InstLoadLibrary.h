#pragma once
#ifndef INST_LOAD_LIBRARY_H
#define INST_LOAD_LIBRARY_H
...
struct InstLoadLibraryArgs {
    ADDRINT lpLibFileName;
};

class InstLoadLibrary : public InstrumentationStrategy {
public:
