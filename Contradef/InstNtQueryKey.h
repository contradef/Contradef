#pragma once
#ifndef INST_NT_QUERY_KEY_H
#define INST_NT_QUERY_KEY_H
...
struct InstNtQueryKeyArgs {
    ADDRINT KeyHandle;
    ADDRINT KeyInformationClass;
    ADDRINT KeyInformation;
    ADDRINT Length;
    ADDRINT ResultLength;
};

class InstNtQueryKey : public InstrumentationStrategy {
public:
