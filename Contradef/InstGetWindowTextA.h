#pragma once
#ifndef INST_GET_WINDOW_TEXT_A_H
#define INST_GET_WINDOW_TEXT_A_H
...
struct GetWindowTextAArgs {
    ADDRINT hWnd;
    ADDRINT lpString;
    ADDRINT nMaxCount;
};

class InstGetWindowTextA : public InstrumentationStrategy {
public:
...
#endif // INST_GET_WINDOW_TEXT_A_H
