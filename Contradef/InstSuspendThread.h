#pragma once
#ifndef INST_SUSPEND_THREAD_H
#define INST_SUSPEND_THREAD_H
...
struct SuspendThreadArgs {
    ADDRINT hThread;
};

class InstSuspendThread : public InstrumentationStrategy {
public:
