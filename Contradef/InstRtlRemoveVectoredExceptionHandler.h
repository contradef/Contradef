#pragma once
#ifndef INST_RTL_REMOVE_VECTORED_EXCEPTION_HANDLER_H
#define INST_RTL_REMOVE_VECTORED_EXCEPTION_HANDLER_H
...
struct RtlRemoveVectoredExceptionHandlerArgs {
    ADDRINT Handle;
};

class InstRtlRemoveVectoredExceptionHandler : public InstrumentationStrategy {
public:
...
#endif // INST_RTL_REMOVE_VECTORED_EXCEPTION_HANDLER_H
