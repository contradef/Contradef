#pragma once
#ifndef INST_NT_USER_QUERY_WINDOW_H
#define INST_NT_USER_QUERY_WINDOW_H
...
struct InstNtUserQueryWindowArgs {
    ADDRINT hwnd;
    ADDRINT Index;
};

class InstNtUserQueryWindow : public InstrumentationStrategy {
public:
...
#endif // INST_NT_USER_QUERY_WINDOW_H
