#pragma once
#ifndef INST_RESUME_THREAD_H
#define INST_RESUME_THREAD_H
...
struct ResumeThreadArgs {
    ADDRINT hThread;
};

class InstResumeThread : public InstrumentationStrategy {
public:
