#pragma once
#ifndef INST_SET_THREAD_CONTEXT_H
#define INST_SET_THREAD_CONTEXT_H
...
struct SetThreadContextArgs {
    ADDRINT hThread;
    ADDRINT lpContext;
};

class InstSetThreadContext : public InstrumentationStrategy {
public:
...
#endif // INST_SET_THREAD_CONTEXT_H
