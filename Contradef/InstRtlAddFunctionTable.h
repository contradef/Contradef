#pragma once
#ifndef INST_RTL_ADD_FUNCTION_TABLE_H
#define INST_RTL_ADD_FUNCTION_TABLE_H
...
struct RtlAddFunctionTableArgs {
    ADDRINT FunctionTable;
    ADDRINT EntryCount;
    ADDRINT BaseAddress;
};

class InstRtlAddFunctionTable : public InstrumentationStrategy {
public:
...
#endif // INST_RTL_ADD_FUNCTION_TABLE_H
