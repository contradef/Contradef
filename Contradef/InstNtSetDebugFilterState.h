#pragma once
#ifndef INST_NT_SET_DEBUG_FILTER_STATE_H
#define INST_NT_SET_DEBUG_FILTER_STATE_H
...
struct InstNtSetDebugFilterStateArgs {
    ADDRINT ComponentId;
    ADDRINT Level;
    ADDRINT State;
};

class InstNtSetDebugFilterState : public InstrumentationStrategy {
public:
...
#endif // INST_NT_SET_DEBUG_FILTER_STATE_H
