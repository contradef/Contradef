#pragma once
#ifndef INST_RTL_DELETE_FUNCTION_TABLE_H
#define INST_RTL_DELETE_FUNCTION_TABLE_H
...
struct RtlDeleteFunctionTableArgs {
    ADDRINT FunctionTable;
};

class InstRtlDeleteFunctionTable : public InstrumentationStrategy {
public:
...
#endif // INST_RTL_DELETE_FUNCTION_TABLE_H
