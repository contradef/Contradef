#pragma once
#ifndef INST_GET_ENVIRONMENT_VARIABLE_A_H
#define INST_GET_ENVIRONMENT_VARIABLE_A_H
...
struct GetEnvironmentVariableAArgs {
    ADDRINT lpName;
    ADDRINT lpBuffer;
    DWORD nSize;
};

class InstGetEnvironmentVariableA : public InstrumentationStrategy {
public:
...
#endif // INST_GET_ENVIRONMENT_VARIABLE_A_H
