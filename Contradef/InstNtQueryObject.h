#pragma once
#ifndef INST_NT_QUERY_OBJECT_H
#define INST_NT_QUERY_OBJECT_H
...
struct InstNtQueryObjectArgs {
    ADDRINT Handle;
    ADDRINT ObjectInformationClass;
    ADDRINT ObjectInformation;
    ADDRINT ObjectInformationLength;
    ADDRINT ReturnLength;
};

class InstNtQueryObject : public InstrumentationStrategy {
public:
