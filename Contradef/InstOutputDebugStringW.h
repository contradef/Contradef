#pragma once
#ifndef INST_OUTPUT_DEBUG_STRING_W_H
#define INST_OUTPUT_DEBUG_STRING_W_H
...
struct OutputDebugStringWArgs {
    ADDRINT lpOutputString;
};

class InstOutputDebugStringW : public InstrumentationStrategy {
public:
...
private:
    ...
    static VOID CallbackAfter(THREADID tid, UINT32 callId, ADDRINT instAddress, ADDRINT  rtn, CONTEXT* ctx, ADDRINT* retValAddr, ADDRINT returnAddress, ADDRINT lpOutputString);
};

#endif // INST_OUTPUT_DEBUG_STRING_W_H
