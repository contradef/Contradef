#pragma once
#ifndef INST_CREATE_EVENT_W_H
#define INST_CREATE_EVENT_W_H
...
struct CreateEventWArgs {
    ADDRINT lpEventAttributes;
    ADDRINT bManualReset;
    ADDRINT bInitialState;
    ADDRINT lpName;
};

class InstCreateEventW : public InstrumentationStrategy {
public:
