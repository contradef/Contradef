#pragma once
#ifndef INST_GET_CURRENT_THREAD_H
#define INST_GET_CURRENT_THREAD_H
...
class InstGetCurrentThread : public InstrumentationStrategy {
public:
...
#endif // INST_GET_CURRENT_THREAD_H
