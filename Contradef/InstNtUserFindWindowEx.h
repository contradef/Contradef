#pragma once
#ifndef INST_NT_USER_FIND_WINDOW_EX_H
#define INST_NT_USER_FIND_WINDOW_EX_H
...
struct InstNtUserFindWindowExArgs {
    ADDRINT hwndParent;
    ADDRINT hwndChildAfter;
    ADDRINT lpszClass;
    ADDRINT lpszWindow;
};

class InstNtUserFindWindowEx : public InstrumentationStrategy {
public:
...
#endif // INST_NT_USER_FIND_WINDOW_EX_H
