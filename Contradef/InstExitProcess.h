#pragma once
#ifndef INST_EXIT_PROCESS_H
#define INST_EXIT_PROCESS_H
...
struct ExitProcessArgs {
    ADDRINT uExitCode;
};

class InstExitProcess : public InstrumentationStrategy {
public:
...
private:
    ...
    static VOID CallbackBefore(THREADID tid, UINT32 callId, ADDRINT instAddress, ADDRINT rtn, CONTEXT* ctx, ADDRINT returnAddress, ADDRINT uExitCode);
};

#endif // INST_EXIT_PROCESS_H
