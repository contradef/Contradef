#pragma once
#ifndef INST_GET_VERSION_EX_W_H
#define INST_GET_VERSION_EX_W_H
...
struct GetVersionExWArgs {
    ADDRINT lpVersionInfo;
};

class InstGetVersionExW : public InstrumentationStrategy {
public:
