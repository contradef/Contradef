#pragma once
#ifndef INST_REG_QUERY_VALUE_EX_W_H
#define INST_REG_QUERY_VALUE_EX_W_H
...
struct InstRegQueryValueExWArgs {
    ADDRINT hKey;
    ADDRINT lpValueName;
    ADDRINT lpReserved;
    ADDRINT lpType;
...
class InstRegQueryValueExW : public InstrumentationStrategy {
public:
...
#endif // INST_REG_QUERY_VALUE_EX_W_H
