#pragma once
#ifndef INST_GET_FOREGROUND_WINDOW_H
#define INST_GET_FOREGROUND_WINDOW_H
...
class InstGetForegroundWindow : public InstrumentationStrategy {
public:
...
#endif // INST_GET_FOREGROUND_WINDOW_H
