#pragma once
#ifndef INST_START_SERVICE_H
#define INST_START_SERVICE_H
...
struct InstStartServiceArgs {
    ADDRINT hService;
    ADDRINT dwNumServiceArgs;
    ADDRINT lpServiceArgVectors;
};

class InstStartService : public InstrumentationStrategy {
public:
