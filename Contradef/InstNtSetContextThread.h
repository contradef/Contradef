#pragma once
#ifndef INST_NT_SET_CONTEXT_THREAD_H
#define INST_NT_SET_CONTEXT_THREAD_H
...
struct InstNtSetContextThreadArgs {
    ADDRINT ThreadHandle;
    ADDRINT ThreadContext;
};

class InstNtSetContextThread : public InstrumentationStrategy {
public:
...
#endif // INST_NT_SET_CONTEXT_THREAD_H
