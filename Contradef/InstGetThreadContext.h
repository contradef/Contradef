#pragma once
#ifndef INST_GET_THREAD_CONTEXT_H
#define INST_GET_THREAD_CONTEXT_H
...
class InstGetThreadContext : public InstrumentationStrategy {
public:
...
private:
    ...
    static VOID CallbackAfter(THREADID tid, UINT32 callId, ADDRINT instAddress, ADDRINT rtn, CONTEXT* ctx, ADDRINT returnAddress, ADDRINT retVal, ADDRINT lpContext);
};

#endif // INST_GET_THREAD_CONTEXT_H
