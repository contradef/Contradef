#pragma once
#ifndef INST_DELETE_FILE_A_H
#define INST_DELETE_FILE_A_H
...
struct DeleteFileAArgs {
    ADDRINT lpFileName;
};

class InstDeleteFileA : public InstrumentationStrategy {
public:
...
private:
    ...
    static VOID CallbackBefore(THREADID tid, UINT32 callId, ADDRINT instAddress, ADDRINT rtn, CONTEXT* ctx, ADDRINT returnAddress, ADDRINT lpFileName);
