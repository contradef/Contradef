#pragma once
#ifndef INST_RTL_ADD_VECTORED_EXCEPTION_HANDLER_H
#define INST_RTL_ADD_VECTORED_EXCEPTION_HANDLER_H
...
struct RtlAddVectoredExceptionHandlerArgs {
    ADDRINT First;
    ADDRINT Handler;
};

class InstRtlAddVectoredExceptionHandler : public InstrumentationStrategy {
public:
...
#endif // INST_RTL_ADD_VECTORED_EXCEPTION_HANDLER_H
