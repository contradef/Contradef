#pragma once
#ifndef INST_GET_COMMAND_LINE_A_H
#define INST_GET_COMMAND_LINE_A_H
...
// Não há argumentos para GetCommandLineA, portanto não precisamos de uma estrutura de argumentos

class InstGetCommandLineA : public InstrumentationStrategy {
public:
...
private:
    ...
    // Como GetCommandLineA não possui parâmetros, o CallbackBefore não precisa registrar nada além do contexto
...
#endif // INST_GET_COMMAND_LINE_A_H
