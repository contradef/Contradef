#pragma once
#ifndef INST_WAIT_FOR_SINGLE_OBJECT_H
#define INST_WAIT_FOR_SINGLE_OBJECT_H
...
struct WaitForSingleObjectArgs {
    ADDRINT hHandle;
    ADDRINT dwMilliseconds;
};

class InstWaitForSingleObject : public InstrumentationStrategy {
public:
...
#endif // INST_WAIT_FOR_SINGLE_OBJECT_H
#pragma once
