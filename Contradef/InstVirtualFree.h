#pragma once
#ifndef INST_VIRTUAL_FREE_H
#define INST_VIRTUAL_FREE_H
...
struct VirtualFreeArgs {
    ADDRINT lpAddress;
    ADDRINT dwSize;
    ADDRINT dwFreeType;
};

class InstVirtualFree : public InstrumentationStrategy {
public:
