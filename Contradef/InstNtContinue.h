#pragma once
#ifndef INST_NT_CONTINUE_H
#define INST_NT_CONTINUE_H
...
struct InstNtContinueArgs {
    ADDRINT ContextRecord;
    ADDRINT TestAlert;
};

class InstNtContinue : public InstrumentationStrategy {
public:
