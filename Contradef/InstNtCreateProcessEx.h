#pragma once
#ifndef INST_NT_CREATE_PROCESS_EX_H
#define INST_NT_CREATE_PROCESS_EX_H
...
struct InstNtCreateProcessExArgs {
    ADDRINT ProcessHandle;
    ADDRINT DesiredAccess;
    ADDRINT ObjectAttributes;
    ADDRINT ParentProcess;
    ADDRINT InheritObjectTable;
    ADDRINT SectionHandle;
    ADDRINT DebugPort;
    ADDRINT ExceptionPort;
    ADDRINT CreateFlags;
};

class InstNtCreateProcessEx : public InstrumentationStrategy {
public:
...
#endif // INST_NT_CREATE_PROCESS_EX_H
