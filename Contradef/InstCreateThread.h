#pragma once
#ifndef INST_CREATE_THREAD_H
#define INST_CREATE_THREAD_H
...
struct CreateThreadArgs {
    ...
    ADDRINT dwStackSize;
    ADDRINT lpStartAddress;
    ADDRINT lpParameter;
    ADDRINT dwCreationFlags;
    ADDRINT lpThreadId;
};

class InstCreateThread : public InstrumentationStrategy {
public:
