#pragma once
#ifndef INST_NT_QUERY_VIRTUAL_MEMORY_H
#define INST_NT_QUERY_VIRTUAL_MEMORY_H
...
struct InstNtQueryVirtualMemoryArgs {
    ADDRINT ProcessHandle;
    ADDRINT BaseAddress;
    ADDRINT MemoryInformationClass;
    ADDRINT MemoryInformation;
    ADDRINT MemoryInformationLength;
    ADDRINT ReturnLength;
};

class InstNtQueryVirtualMemory : public InstrumentationStrategy {
public:
...
#endif // INST_NT_QUERY_VIRTUAL_MEMORY_H
